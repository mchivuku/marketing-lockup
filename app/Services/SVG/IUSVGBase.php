...
class IUSVGBase extends SVGBase {
    ...
    function init($width, $height, $fixed=false){
    ...
    function addLogo() {
        $logo = '<polygon transform="translate(0 0)" fill="#FFFFFF"
points="35.6,16.4 35.6,20 38.1,20 38.1,40.1 32.8,40.1 32.8,13.6 35.6,13.6 35.6,10 22.4,10 22.4,13.6
